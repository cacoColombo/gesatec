 ...
 * @author augusto
 */
public class EspecializacaoFormulario extends javax.swing.JDialog {

    public static EspecializacaoBusca parent;
    
    /**
     * Creates new form AtendenteFormulario
     */
    public EspecializacaoFormulario(EspecializacaoBusca parent, boolean modal) {
        this.parent = parent;
        this.setModal(modal);
    ...
    private void initComponents() {
        ...
        jTabbedPane1.addTab("Especialização", jPanel2);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EspecializacaoFormulario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EspecializacaoFormulario dialog = new EspecializacaoFormulario(parent, true);
